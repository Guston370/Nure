...
public class SettingsActivity extends BaseActivity {
    ...
    private void setupSwitchListeners() {
        ...
        if (darkModeSwitch != null) {
            darkModeSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                // Note: In a full implementation, you'd restart the activity or apply theme changes
            });
        }
    }
    ...
    private void openPrivacyPolicy() {
        ...
        builder.setMessage("Your privacy is important to us. We collect minimal data necessary to provide our health scanning services.\n\n" +
